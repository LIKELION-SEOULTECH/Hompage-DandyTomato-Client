    ...
    return (
        <div className="relative h-screen w-screen overflow-x-auto bg-[#f5f4f2]">
            <div className="relative h-full w-full">
                ...
                <div className="absolute top-[185px] right-[160px]">
                    <div className="relative box-border flex flex-row content-stretch items-center justify-end gap-4 p-0">
                        <FilterButton text="기수" />
