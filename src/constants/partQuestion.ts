...
export const partQuestion: PartData[] = [
    ...
    },
    {
        name: '디자인 DESIGN',
        description:
            '프로젝트에서 사용자들이 편리하게 이용할 수 있도록 UX/UI 디자인을 만들고, 서비스의 비주얼 \n아이덴티티를 구축하는 역할을 \해요.',
        questions: [
            {
                text: '기획자로서 개발자, 디자이너와 협업할 때 가장 중요한 점은 무엇이라고\n생각하시나요?',
                type: 'part'
    ...
    },
    {
        name: '백엔드 BACK-END',
        description:
            '서비스 요구에 맞는 API를\n개발하고, 배포와 운영을 통해 \n서버와 DB를 효율적으로 관리해요. 프레임워크를 활용해 실제 서비스 운영에 필요한 인프라를 구현해요.',
        questions: [
            {
                text: '기획자로서 개발자, 디자이너와 협업할 때 가장 중요한 점은 무엇이라고\n생각하시나요?',
                type: 'part'
    ...
    },
    {
        ...
        description:
            '사용자 인터페이스를 구현하고, 서버와의 통신을 통해 서비스를 구성해요. 웹 클라이언트 개발에 필요한 기술을 기초부터 \n심화까지 배워나가요.',
        questions: [
            {
                text: '기획자로서 개발자, 디자이너와 협업할 때 가장 중요한 점은 무엇이라고\n생각하시나요?',
                type: 'part'
